...
function VoicePanel(props) {
  ...
  useStyle(UI_CSS);
  const toggleVoice = () => { if (setEnabled) setEnabled(!state.enabled); };
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "span",
          {
            ...
            children: !state.enabled ? "语音已关闭" : !state.ttsEnabled ? "播报已关闭" : state.caption ?? (state.connected ? "voice ready" : "voice offline")
          },
          state.caption ?? "idle"
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            className: "dshv-toggle",
            onClick: toggleVoice,
            title: state.enabled ? "关闭聊天" : "开启聊天",
            style: {
              border: "none",
              background: state.enabled ? "rgba(59, 130, 246, 0.25)" : "rgba(107, 114, 128, 0.2)",
            ...
            children: state.enabled ? "\u{1F4AC} 聊天" : "\u{1F4AC} 聊天"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            className: "dshv-toggle-rec",
            onClick: (e) => { e.stopPropagation(); toggleRec(); },
            ...micBridge?.actionsRef.current?.holdProps || {},
            title: isRecording ? "\u505C\u6B62\u5F55\u97F3" : "\u5F00\u59CB\u5F55\u97F3",
            style: {
              border: "none",
              background: isRecording ? "rgba(248, 81, 73, 0.3)" : "rgba(107, 114, 128, 0.2)",
              color: isRecording ? "#f85149" : "#8b949e",
              borderRadius: 999,
              padding: "5px 12px",
              fontSize: 12,
              fontWeight: 600,
            ...
            children: isRecording ? "\u{1F534} \u5F55\u97F3" : "\u{26AB} \u5F55\u97F3"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            className: "dshv-toggle-tts",
            onClick: (e) => { e.stopPropagation(); toggleTts(); },
            title: state.ttsEnabled ? "\u5173\u95ED\u64AD\u62A5" : "\u5F00\u542F\u64AD\u62A5",
            style: {
              border: "none",
              background: state.ttsEnabled ? "rgba(46, 160, 67, 0.25)" : "rgba(107, 114, 128, 0.2)",
              color: state.ttsEnabled ? "#2ea043" : "#6b7280",
              borderRadius: 999,
              padding: "5px 12px",
              fontSize: 12,
              fontWeight: 600,
            ...
            children: state.ttsEnabled ? "\u{1F50A} \u64AD\u62A5" : "\u{1F507} \u64AD\u62A5"
          }
        ),
